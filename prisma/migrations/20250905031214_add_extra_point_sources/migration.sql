/*
  ...
  - The values [ACTIVITY] on the enum `PointSources` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "PointSources_new" AS ENUM ('TRANSACTION', 'DIRECT_REFERRAL', 'INDIRECT_REFERRAL', 'ACTIVISION_REFERRAL', 'QUESTS', 'ONCHAIN_ACTIVITY', 'SOCIAL_ACTIVITY');
